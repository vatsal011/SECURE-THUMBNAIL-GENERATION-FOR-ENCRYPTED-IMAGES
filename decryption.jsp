...
<title>Thumbnail Preserving Decryption Page</title>
</head>
<style>
...
<body bgcolor="#ccccff">
	...
	<br><br><br><br>
	<center>
		<form action="DecryptFile" method="post" enctype="multipart/form-data">
		<table width="10%">
			<tr>
				<th><h1>Decryption for Images</h1></th>
			</tr>
			<tr>
				<td>Select File : <input type="file" name="imageFiles" /><br><br></td>
			</tr>
			<tr>
				<td><input type="submit" name="upload" value="Decrypt File"></td>
			</tr>
		</table>
		</form>
	</center>
